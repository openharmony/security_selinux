...
def main(args):
    ...
    temp_vendor_cil_path = os.path.join(output_path, "temp_vendor.cil")
    ...
    # build vendor.cil
    build_cil(args, temp_vendor_cil_path, vendor_output_conf)
    ...
    cmd = ["grep -v -f", min_cil_path, temp_vendor_cil_path, ">", vendor_cil_path]
    run_command(cmd)
